...
foreach ($product as $pro) {
	$tr .=' <div class="card mt-4">
	<img  style="width:500px; height:350px;" class="card-img-top img-fluid" src="'.$pro['link'].'" alt="">
	<div class="card-body">
	  <h3 class="card-title">'.$pro['title'].'</h3>
	  <h4>Price: '.$pro['price'].' $</h4>
	  <p class="btn btn-success" id="percent">'.$pro['percent'].'</p>
